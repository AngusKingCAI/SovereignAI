...
4. Read and execute `.devin/skills/open/SKILL.md` → execute plan steps → read and execute `.devin/skills/verify/SKILL.md` per edit → read and execute `.devin/skills/close/SKILL.md`. No shortcuts.
