...
**Files changed**:
- sovereignai/shared/types.py (extended: TaskState, TaskStateChanged, Task, ComponentStatus, TASK_STATE_CHANNEL, DAGSpec per Rev3 Finding 6)
...
*Plan 3 — Execution Layer. Rev3. Architect draft. Part of Plans 1-4 batch — Round Table reviews alongside plan-1-Rev3, plan-2-Rev3, plan-4-Rev3, and the shared context brief. Adjudication logs above record Rev1 → Rev2 → Rev3 changes per GR4.*
