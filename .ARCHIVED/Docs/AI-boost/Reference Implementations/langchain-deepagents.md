...
**Source URL:** https://github.com/langchain-ai/deepagents

**Description:** Deep Agents is an open source agent harness — an opinionated agent that runs out of the box. It provides a comprehensive framework for building AI agents with advanced capabilities like sub-agents, filesystem access, context management, shell access, persistent memory, human-in-the-loop approval, skills, and tools.
