...
**Source URL:** https://docs.langchain.com/langsmith/observability-concepts

**Description:** This document explains the core data structure concepts in LangSmith Observability, including how projects, traces, runs, and threads are organized, as well as trace enrichment options like feedback, tags, and metadata.
