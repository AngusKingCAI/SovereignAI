# OpenAI Developers Agents Guide
...
- **TypeScript SDK**: [https://github.com/openai/openai-agents-js](https://github.com/openai/openai-agents-js)
- **Python SDK**: [https://github.com/openai/openai-agents-python](https://github.com/openai/openai-agents-python)
...
| **Tools**                  | Platform tools, function calling, and remote [Model Context Protocol (MCP)](https://developers.openai.com/api/docs/guides/tools-connectors-mcp)     | Platform tools attached to reusable agents, plus tool wrappers, local MCP connections, and [agents as tools](https://developers.openai.com/api/docs/guides/agents/orchestration#use-agents-as-tools) |
| **State management**       | You manage state yourself                                                                                              | Built-in sessions with persistent memory                                                                                                                                                             |
| **Orchestration**          | You implement loops and branching                                                                                      | Built-in agent loop, handoffs, and tool execution                                                                                                                                                   |
| **Guardrails**             | You implement validation                                                                                               | Built-in guardrails with parallel validation                                                                                                                                                         |
| **Use cases**              | Custom model-powered features, single-turn or simple multi-turn workflows                                              | Multi-step workflows with specialists, approval flows, and tool coordination                                                                                                                         |
