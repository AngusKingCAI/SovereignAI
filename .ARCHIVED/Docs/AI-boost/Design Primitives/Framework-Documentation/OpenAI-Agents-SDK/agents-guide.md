...
- **TypeScript SDK**: [Open the TypeScript SDK repository on GitHub.](https://github.com/openai/openai-agents-js)
- **Python SDK**: [Open the Python SDK repository on GitHub.](https://github.com/openai/openai-agents-python)
...
| **Runtime**                | Your application                                                                                                       | SDK runner                                                                                                                                                                                          |
| **State**                  | You manage conversation state directly                                                                                 | Sessions (managed or custom)                                                                                                                                                                        |
| **Tracing**                | Platform traces per request                                                                                            | Built-in tracing and evaluation hooks                                                                                                                                                               |
| **Guardrails**             | Platform guardrails                                                                                                    | SDK guardrails + platform guardrails                                                                                                                                                                |
| **Streaming**              | Item streaming and delta streaming                                                                                     | Streaming events and delta streaming                                                                                                                                                                |
| **Code**                   | API calls in your application                                                                                         | SDK code in your application                                                                                                                                                                       |
