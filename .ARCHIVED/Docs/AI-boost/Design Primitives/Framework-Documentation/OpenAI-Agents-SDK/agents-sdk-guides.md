# OpenAI Agents SDK - Developer Guides
...
- **TypeScript SDK**: [GitHub Repository](https://github.com/openai/openai-agents-js)
- **Python SDK**: [GitHub Repository](https://github.com/openai/openai-agents-python)
