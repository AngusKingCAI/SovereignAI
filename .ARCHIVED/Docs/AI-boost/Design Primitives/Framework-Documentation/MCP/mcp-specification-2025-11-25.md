...
**Source URL:** https://modelcontextprotocol.io/specification/2025-11-25/index
...
This specification defines the authoritative protocol requirements, based on the TypeScript schema in [schema.ts](https://github.com/modelcontextprotocol/specification/blob/main/schema/2025-11-25/schema.ts).
...
- **Base Protocol**: Core JSON-RPC protocol details
- **Server Features**: Server-side capabilities and features
- **Client Features**: Client-side capabilities and features
