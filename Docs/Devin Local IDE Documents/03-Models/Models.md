...
**Note**: Short names like `opus`, `sonnet`, `swe`, `codex`, and `gemini` always resolve to the latest version in that model family.
...
**Tip**: Enterprise teams can restrict which models are available through [Team Settings](../07-Enterprise/Team-Settings.md).