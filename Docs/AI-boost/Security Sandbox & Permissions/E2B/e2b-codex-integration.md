# E2B Codex Integration

**Source URL:** https://e2b.dev/docs/agents/codex
...
- **SSH access**: Connect to the sandbox via SSH for interactive sessions

This integration provides secure sandbox environments for running OpenAI Codex with full filesystem, terminal, and git access capabilities.
