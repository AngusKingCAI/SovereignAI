...
**Source URL:** https://github.com/e2b-dev/e2b/
...
The E2B repository contains:
- **packages/** - Core packages and SDK implementations
...
This is the main repository for the E2B infrastructure, providing open-source sandbox environments for AI code execution with both JavaScript and Python SDK support.
