...
**Source URL:** http://github.com/daytonaio/daytona
...
This repository contains the open-source Daytona platform for secure and elastic infrastructure runtime for AI-generated code execution and agent workflows. Note that as of June 2026, core development has moved to a private codebase, and this repository is no longer maintained but remains available for use under the existing license.
