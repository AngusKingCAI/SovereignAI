...
**Source URL:** https://github.com/modelcontextprotocol/specification

**Description:** This repository contains the MCP specification, MCP protocol schema, and official MCP documentation. The schema is defined in TypeScript first but made available as JSON Schema for wider compatibility. The official MCP documentation is built using Mintlify and available at modelcontextprotocol.io.
