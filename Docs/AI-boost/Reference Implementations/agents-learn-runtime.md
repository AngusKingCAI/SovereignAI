...
**Source URL:** https://github.com/mrcabbage972/agents-learn-runtime

**Description:** Official repository for the paper "Agents Learn Their Runtime: Interpreter Persistence as Training-Time Semantics". This study isolates the effect of persistent executable state during training to determine if it functions as a learned inductive bias or an inference-time scaffold.
