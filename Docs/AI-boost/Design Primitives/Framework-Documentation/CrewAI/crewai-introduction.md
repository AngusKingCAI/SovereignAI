...
**Source URL:** https://docs.crewai.com/en/introduction
...
- **Production-Grade Flows**: Build reliable, stateful workflows that can handle long-running processes and complex logic.
- **Autonomous Crews**: Deploy teams of agents that can plan, execute, and collaborate to achieve high-level goals.
- **Flexible Tools**: Connect your agents to any API, database, or local tool.
- **Enterprise Security**: Designed with security and compliance in mind for enterprise deployments.
...
- **Install CrewAI**: Get started with CrewAI in your development environment.
- **Quick Start**: Scaffold a Flow, run a crew with one agent, and generate a report end to end.
- **Join the Community**: Connect with other developers, get help, and share your CrewAI experiences.
