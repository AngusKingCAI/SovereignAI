# Governance/GovernanceScripts/Enforcement/post_tool_validator.py
# Frontmatter: id: post_tool_validator, version: 1.0.0, owner: SovereignAI, updated: 2026-08-02, purpose: PostToolUse hook - advisory validation for non-blocking rules, agent: all, persona: governance
#!/usr/bin/env python3
"""
