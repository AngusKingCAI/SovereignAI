# Governance/GovernanceScripts/Validation/lint_ssot_duplicates.py
# Frontmatter: id: lint_ssot_duplicates, version: 1.0.0, owner: SovereignAI, updated: 2026-08-02, purpose: SSOT dedup linter — flags duplicate rule statements across Policy Cards, agent: all, persona: governance
#!/usr/bin/env python3
