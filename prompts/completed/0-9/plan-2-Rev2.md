...
- sovereignai/shared/manifest_parser.py (new — TOML parser, validates required fields per Finding 2; wraps ComponentId per Finding 4)
...
*Plan 2 — Discovery Layer. Rev2. Architect draft. Part of Plans 1-4 batch — Round Table reviews alongside plan-1-Rev2, plan-3-Rev2, plan-4-Rev2, and the shared context brief. Adjudication log above records Rev1 → Rev2 changes per GR4.*
