...
Open questions resolved: Q-21.1 (CapabilityCategory.SKILL enum), Q-21.2 (skill_id vs capability name lookup)
...
- Concrete close() implementations must be idempotent — safe to call more than once. ToolSessionRegistry.close_all() (Plan 22 S1.1) may invoke close() multiple times on the same runner instance.
