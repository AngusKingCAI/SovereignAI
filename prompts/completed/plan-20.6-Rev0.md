...
- `tui/panels/orchestrator.py` — fix B5-B8, B10, B16 (S3)
- `tui/panels/workers.py` — fix B5-B8, B10, B16 (S3)
- `tui/panels/tasks.py` — fix B5-B8, B10, B16 (S3)
- `tui/panels/skills.py` — fix B5-B8, B10, B16 (S3)
- `tui/panels/memory.py` — fix B5-B8, B10, B16 (S3)
- `tui/panels/models.py` — fix B5-B8, B10, B16 (S3)
