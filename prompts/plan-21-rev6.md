...
- Register discovered capabilities in existing CapabilityGraph (sovereignai/shared/capability_graph.py) per DD-21.1.10. Use CapabilityGraph.register() with ComponentManifest.
...
- Register CapabilityGraph as singleton (already exists in repo; ensure it is registered if not already).
