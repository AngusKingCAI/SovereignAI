...
- S4.3: Add tests/test_hardware_panel.py covering: SSE stream returns 200 with media_type text/event-stream and emits JSON frames; multi-GPU DTO; disk enumeration; generator terminates on disconnect.
