...
def test_negotiate_core_compatible() -> None:
    ...
    core1 = ComponentManifest(  # noqa: E501
    ...
    core2 = ComponentManifest(  # noqa: E501
...
def test_negotiate_core_missing_version() -> None:
    ...
    import sovereignai
    sovereignai_path = str(Path(sovereignai.__file__).resolve().parent)
    core = ComponentManifest(  # noqa: E501
        component_id=ComponentId('core1'),
        version='',
        author='test',
        content_hash='hash1',
    ...
    other = ComponentManifest(  # noqa: E501
        component_id=ComponentId('core2'),
        version='1.0.0',
        author='test',
        content_hash='hash2',
...
def test_negotiate_plugin_outside_sovereignai() -> None:
    mock_graph = MagicMock()
    mock_trace = MagicMock()
    plugin = ComponentManifest(  # noqa: E501
