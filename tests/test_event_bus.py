...
def sample_event() -> Event:
    return Event(channel=Channel('test-channel'), correlation_id=uuid4(), timestamp=now_utc())
...
def test_unrelated_channels_are_isolated(event_bus: EventBus, sample_event: Event) -> None:
    ...
    event_a = Event(channel=Channel('channel-a'), correlation_id=uuid4(), timestamp=now_utc())
