...
def register(self, component_id, manifest, instance) -> None:
    ...
    if self._dev_mode:
        ...
        if not hasattr(self, '_conformance_runner') or self._conformance_runner is None:
...
# Rev8: pass dev_mode to CapabilityGraph constructor, do NOT set os.environ
# CapabilityGraph is constructed with: CapabilityGraph(..., dev_mode=args.dev)
```
