...
def main():
    ...
    sync_file(
        ".agent/executor/scripts/get_scoped_tests.py",
        "get_scoped_tests.py",
        workflow_dir,
    )
    sync_file(
    ...
    sync_file(
        ".agent/executor/scripts/is_scan_plan.py",
        "is_scan_plan.py",
        workflow_dir,
    )
    ...
    # Executor checks
    sync_file(
        ".agent/executor/checks/check_model_registry_adapter_registry.py",
        "check_model_registry_adapter_registry.py",
        workflow_dir,
    )
    sync_file(
        ".agent/executor/checks/check_model_registry_no_direct_provider_calls.py",
        "check_model_registry_no_direct_provider_calls.py",
        workflow_dir,
    )
    sync_file(
        ".agent/executor/checks/check_model_registry_transaction_safety.py",
    ...
    sync_file(
        ".agent/executor/scripts/ar_checks/check_plan_immutability.py",
    ...
    sync_file(
        ".agent/executor/scripts/ar_checks/check_rule_conciseness.py",
    ...
    sync_file(
        ".agent/executor/scripts/ar_checks/check_p4_compliance.py",
        "check_p4_compliance.py",
        workflow_dir,
    )
    sync_file(
        ".agent/executor/scripts/ar_checks/check_tracing.py",
        "check_tracing.py",
        workflow_dir,
    )
    sync_file(
        ".agent/executor/scripts/ar_checks/check_component_manifest_kwargs_ar15.py",
        "check_component_manifest_kwargs_ar15.py",
        workflow_dir,
    )
    ...
    sync_file(
        ".agent/executor/scripts/landmine_checks/detect_m1.py",
        "detect_m1.py",
        workflow_dir,
    )
    sync_file(
        ".agent/executor/scripts/landmine_checks/detect_m4.py",
        "detect_m4.py",
        workflow_dir,
    )
