...
ALLOWLIST = {
    ...
    "app/sovereignai/tests/__init__.py",
    "app/sovereignai/tests/test_lifecycle_manager.py",
    "app/sovereignai/tests/test_lifecycle_hooks.py",
    "app/sovereignai/tests/test_lifecycle_health.py",
    "app/sovereignai/tests/test_lifecycle_shutdown.py",
    ...
    "coverage.json",
    "app/tui/tests/test_final_90_percent.py",
    "app/tui/tests/__init__.py",
    "app/tui/panels/hardware.py",
    "app/tui/tests/test_panels_compose.py",
    "app/tui/tests/test_debt7_verification.py",
    "app/tui/main.py",
    "app/tui/panels/memory.py",
    "app/tui/tests/test_panel_remaining_coverage.py",
    "app/tui/panels/tasks.py",
    ".agent/executor/tests/conftest.py",
    "app/tui/tests/conftest.py",
    "app/tui/tests/test_panels.py",
    "app/tui/panels/models.py",
    "app/tui/panels/logs.py",
    ".agent/executor/.rules-cache.json",
    ".agent/executor/scripts/get_scoped_tests.py",
    "app/tui/tests/test_main_lifecycle_edge_cases.py",
    ".agent/executor/scripts/move_completed_plans.py",
    "app/tui/client.py",
    "app/tui/tests/test_skills_panel.py",
    "app/tui/error_classification.py",
    "app/tui/tests/test_final_push_90_percent.py",
    ".agent/executor/OR_RULES.md",
    "app/tui/panels/audit.py",
    ".agent/executor/traces/trace-plan-32.jsonl",
    "app/tui/tests/test_reach_90_percent.py",
    "app/tui/tests/test_main_compose_lifecycle.py",
    "app/tui/tests/test_client.py",
    "app/tui/tests/test_final_coverage_gaps.py",
